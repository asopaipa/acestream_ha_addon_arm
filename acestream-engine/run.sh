...
# Obtener variables de configuración de Home Assistant
...
# Ejecutar el comando
exec /acestream/python/bin/ main.py --client-console --live-cache-type memory --live-mem-cache-size 104857600 --disable-sentry --log-stdout $COMMAND_ARGS
